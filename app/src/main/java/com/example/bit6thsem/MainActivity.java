...
/*
    ...
    */
        ...
        serviceButton = findViewById(R.id.btnStartService);
        serviceButton =findViewById(R.id.btnStopService);
...
//                androidPreferenceExample();
    ...
    private void startServiceButton(){
        serviceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startService(new Intent(getApplicationContext(), com.example.bit6thsem.CustomService.class));
